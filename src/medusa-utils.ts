...
import { Constructor, MedusaRepositoryStatic } from './types';
...
export class Utils {
	 ...
	 * @param derivedCtor
	 */
	static repositoryMixin<TEntity, TRepository, OverriddenType>(
		derivedCtor: Constructor<TRepository>
	): MedusaRepositoryStatic<TRepository, OverriddenType> {
		const repository = class base extends Repository<TEntity> {}

		Object.getOwnPropertyNames(repository.prototype).forEach((name) => {
			Object.defineProperty(
				derivedCtor.prototype,
				name,
				Object.getOwnPropertyDescriptor(Repository.prototype, name) || Object.create(null)
			);
		});
