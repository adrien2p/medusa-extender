[medusa-extender](../README.md) / [Exports](../modules.md) / cli/templates/migration-template
...
[src/cli/templates/migration-template.ts:8](https://github.com/octalpixel/medusa-extender/blob/3e7bd11/src/cli/templates/migration-template.ts#L8)
