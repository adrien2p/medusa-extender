[medusa-extender](../README.md) / [Exports](../modules.md) / cli/templates/repository-template
...
[src/cli/templates/repository-template.ts:8](https://github.com/octalpixel/medusa-extender/blob/3e7bd11/src/cli/templates/repository-template.ts#L8)
